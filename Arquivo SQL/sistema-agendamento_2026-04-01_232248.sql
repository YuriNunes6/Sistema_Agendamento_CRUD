...
--
-- Host: 127.0.0.1    Database: sistema-agendamento
-- ------------------------------------------------------
...
CREATE TABLE `agendamentos` (
  ...
  `status` enum('agendado','concluido','cancelado') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'agendado',
...
--
-- Dumping routines for database 'sistema-agendamento'
--
...
-- Dump completed on 2026-04-01 23:22:51
